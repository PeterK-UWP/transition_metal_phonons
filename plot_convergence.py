def plot_convergence(file_name, convergence_threshold, fit_start_index):
    ...
    y_minimum = np.min(y_values) - 2*convergence_threshold
    y_maximum = np.min(y_values) + (8 * convergence_threshold)
    ...
    upper_threshold_label_y = 0.05 * plot_y_range + (np.min(y_values) + convergence_threshold)
    lower_threshold_label_y = -0.05 * plot_y_range + (np.min(y_values) - convergence_threshold)
